...
export function MessageBubble({ message, busy = false, onRegenerate, onVersionChange, onFeedback }: Props) {
  ...
  async function saveFeedback(nextRating: 'up' | 'down', reason?: string, comment?: string) {
    await onFeedback(message.id, activeVersion!.id, nextRating, reason, comment)
